const services = [
  ...
  },
  {
    ...
    desc: "Targeted treatment for spills, traffic marks, pet accidents, and stubborn spots.",
  },
  {
    ...
    <section style={{ padding: "4.5rem 0" }} id="services">
      <div style={{ width: "min(1120px, calc(100% - 2rem))", margin: "0 auto" }}>
        <div style={{ maxWidth: 720, marginBottom: "2rem" }}>
          ...
          <h2 style={{ margin: "0 0 0.9rem", lineHeight: 1.05 }}>Fast service. Premium finish.</h2>
        ...
        >
          {services.map((s) => (
            <article key={s.title} className="card-base" style={{ padding: "1.3rem" }}>
